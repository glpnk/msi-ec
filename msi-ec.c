...
static const char *ALLOWED_FW_G1_1[] __initconst = {
	...
	"17E7EMS1.1", // GP75 Leopard 10SEK / 10SFR / 10SDR
...
static const char *ALLOWED_FW_G1_3[] __initconst = {
	...
	"16V1EMS1.1", // GS66 Stealth 10SFS / 10SE / 10SGS
...
static const char *ALLOWED_FW_G1_13[] __initconst = {
	"16V2EMS1.1", // Creator 15 A10SD / A10SFS / A10SET
	NULL
};
...
static const char *ALLOWED_FW_G2_1[] __initconst = {
	...
	"1583EMS1.1", // Crosshair 15 B12UEZ / B12UGSZ / Pulse  GL66 12UEK / 12UGK / Katana GF66 12UG
	...
	"15K1IMS1.1", // Cyborg 15 A12VF / A13VF / A13VFK
	"16S6EMS1.1", // Prestige 15 A11SCX
	"16S8EMS1.1", // Prestige 15 A12SC / A12UC
	"16V6EMS1.1", // Stealth 15 A13V
	"17L1EMS1.1", // Katana GF76 11UE / 11UG / Crosshair 17 A11UEK
	"17L2EMS1.1", // Katana GF76 11UC / 11UD / Katana 17 B11UCX
	"17L3EMS1.1", // Crosshair 17 B12UGZ / Katana GF76 12UG
...
static const char *ALLOWED_FW_G2_2[] __initconst = {
	"1543EMS1.1", // GP66 Leopard 11UH / 11UG / GE66 Raider 11UE
...
static const char *ALLOWED_FW_G2_3[] __initconst = {
	"14F1EMS1.1", // Summit E14 Flip Evo A12MT / E14 Evo A12M
...
static const char *ALLOWED_FW_G2_6[] __initconst = {
	...
	"16R7IMS1.1",
	"16R8IMS1.1", // Thin GF63 12V(E/F) / 12UCX / 12UC
...
static const char *ALLOWED_FW_G2_10[] __initconst = {
	...
	"17S1IMS2.1", // Raider GE78 HX 14VHG / Vector 17 HX A14V / A13VHG
	...
	"1824EMS1.1", // Titan 18 HX Dragon Edition / Raider 18 HX AI A2XWJG
