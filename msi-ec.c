...
static const char *ALLOWED_FW_G1_0[] __initconst = {
	"14C1EMS1", // Prestige 14 A10SC
	"16S3EMS1", //Prestige 15 A10SC
	NULL
};
...
static const char *ALLOWED_FW_G1_1[] __initconst = {
	"16U7EMS1", // GP65 / GL65 Leopard 10S
	"16U7EMS1", // GL65 Leopard 9SD
	"17F2EMS1", // GF75 Thin 9SC
	"17F3EMS1", // GF75 Thin 9S(D/E)
	"17F3EMS2", // GF75 Thin 10SER
	"17F4EMS2", // GF75 Thin 9SCSR
	"17F5EMS1", // GF75 Thin 10UEK
	"17F6EMS1", // GF75 Thin 10UC / 10UD / 10SC
	"17E7EMS1", // GP75 Leopard 10SEK, GL75 Leopard 10SFR/10SDR
	"17E8EMS1", // GL75 Leopard 10SCXR
	NULL
};
...
static const char *ALLOWED_FW_G1_2[] __initconst = {
	"158LEMS1", // Alpha 15 B5EE / B5EEK
	"17LLEMS1", // Alpha 17 B5EEK
	"15CKEMS1", // Delta 15 A5EFK
	NULL
};
...
static const char *ALLOWED_FW_G1_3[] __initconst = {
	"1541EMS1", // GE66 Raider 10SF
	"1542EMS1", // GP66 Leopard 10UG / 10UE / 10UH
	"16Q2EMS1", // GS65 Stealth Thin 8RE / 8RF
	"16Q3EMS1", // P65 Creator 8RE - single color kb bl, but 00 val
	"16Q4EMS1", // GS65 Stealth 8S / 9S(D/F)
	"16V1EMS1", // GS66 Stealth 10SFS ,10SE
	"16V3EMS1", // GS66 Stealth 10UE
	NULL
};
...
static const char *ALLOWED_FW_G1_5[] __initconst = {
	"14JKEMS1", // Modern 14 C5M,C7M
	"1551EMS1", // Modern 15 A10M
	NULL
};
...
static const char *ALLOWED_FW_G1_6[] __initconst = {
	"14D1EMS1", // Modern 14 B10MW
	"14DKEMS1", // Modern 14 B4MW
	"14DLEMS1", // Modern 14 B5M
	"155LEMS1", // Modern 15 A5M
	"15HKEMS1", // Modern 15 B7M
	NULL
};
...
static const char *ALLOWED_FW_G1_7[] __initconst = {
	"16R1EMS1", // GF63 8RC-249
	"16R3EMS1", // GF63 Thin 9SC
	"16R4EMS1", // GF63 Thin 10SCX(R) / 10SCS(R)
	"16R4EMS2", // GF63 Thin 9SCSR
	"16R5EMS1", // GF63 Thin 10U(C/D) / 10SC
	"16W1EMS1", // GF65 Thin 9SE(X(R)) / 9SD
	"16W1EMS2", // GF65 Thin 10SCSXR / 10SD(R) / 10SE(R)
	"16W2EMS1", // GF65 Thin 10UE
	NULL
};
...
static const char *ALLOWED_FW_G1_8[] __initconst = {
	"16WKEMS1", // Bravo 15 A4DDR
	"16S1EMS1", // PS63 MODERN 8RD
	NULL
};
...
static const char *ALLOWED_FW_G1_9[] __initconst = {
	"17G1EMS2", // P75  CREATOR 9SG
	"17G1EMS1", // GS75 Stealth 8SF/9SF
	"17G3EMS1", // GS75 Stealth 10SF
	NULL
};
...
static const char *ALLOWED_FW_G1_10[] __initconst = {
	"16P5EMS1", // GE63 Raider 8RE
	"1782EMS1", // GT72 6QE Dominator Pro
	NULL
};
...
static const char *ALLOWED_FW_G1_11[] __initconst = {
	"158MEMS1", // Bravo 15 B5ED
	"158KEMS1", // Bravo 15 B5DD
	NULL
};
...
static const char *ALLOWED_FW_G1_13[] __initconst = {
	"16V2EMS1", // Creator 15 A10SD
	"16V2EMS1", // Creator 15 A10SET
	NULL
};
...
static const char *ALLOWED_FW_G2_0[] __initconst = {
	"14D2EMS1", // Modern 14 B11M
	"14D3EMS1", // Modern 14 B11MOU
	"1552EMS1", // Modern 15 A11M
	"159KIMS1", // Prestige A16 AI+ A3HMG, Summit A16 AI+ A3HMTG
	"15H1IMS1", // Modern 15 B13M
	"15H5EMS1", // Modern 15 H AI C1MG
	NULL
};
...
static const char *ALLOWED_FW_G2_1[] __initconst = {
	"14C4EMS1", // Prestige 14 A11SCX
	"14C6EMS1", // Prestige 14 Evo A12M
	"1581EMS1", // Katana GF66 11UE / 11UG
	"1582EMS1", // Pulse GL66 11UDK, Katana GF66 11UC / 11UD
	"1583EMS1", // Crosshair 15 B12UEZ / B12UGSZ / Pulse  GL66 12UEK / Pulse  GL66 12UGK / Katana GF66 12UG
	"1584EMS1", // Katana GF66 12U(C/D) (ENE)
	"1584EMS1",
	"1584IMS1", // Katana GF66 12UDO (ITE) (#467)
	"1585EMS1", // Creator M16 B13VF / Katana 15 B13VGK / Pulse 15 B13VGK
	"1585EMS2", // Katana 15 B12VEK / B12VFK / B12VGK
	"158NIMS1", // Bravo 15 C7V / Bravo 15 C7VFKP / Bravo 15 C7UCX
	"158PIMS1", // Bravo 15 B7ED / Bravo 15 B7E
	"1591EMS1", // Summit E16 Flip A11UCT
	"1592EMS1", // Summit E16 Flip A12UCT / A12MT
	"1594EMS1", // Prestige 16 Studio A13VE
	"1596EMS1", // Summit E16 AI Studio A1VETG
	"15H2IMS1", // Modern 15 B12HW
	"15K1IMS1", // Cyborg 15 A12VF / Cyborg 15 A13VF / Cyborg 15 A13VFK 
	"16S6EMS1", // Prestige 15 A11SCX
	"16S8EMS1", // Prestige 15 A12SC / A12UC
	"16V6EMS1", // Stealth 15 A13V
	"17L1EMS1", // Katana GF76 11UE / Crosshair 17 A11UEK / Katana GF76 11UG
	"17L2EMS1", // Katana GF76 11UC / 11UD / Katana 17 B11UCX
	"17L3EMS1", // Crosshair 17 B12UGZ / Katana GF76 12UG
	"17L4EMS1", // Katana GF76 12UC
	"17LNIMS1", // Bravo 17 C7VE / Katana A17 AI B8VF
	"17M1EMS2", // Creator 17 B11UE
	NULL
};
...
static const char *ALLOWED_FW_G2_2[] __initconst = {
	"1543EMS1", // GP66 Leopard 11UH / GP66 Leopard 11UG / GE66 Raider 11UE
	"1544EMS1", // Vector GP66 12UGS
	"1545IMS1", // Raider GE67 HX 12U
	"16V4EMS1", // GS66 Stealth 11UE / 11UG
	"16V5EMS1", // Stealth GS66 12UE / 12UGS
	"17K3EMS1", // GE76 Raider 11U / 11UH / 11UE / GP76 Leopard 11UG
	"17K4EMS1", // Raider GE76 12UE / Raider GE76 12UGS / Vector GP76 12UH
	"17K5IMS1", // Raider GE77 HX 12UGS
	"17KKIMS1", // Alpha 17 C7VF / C7VG
	"17M1EMS1", // Stealth GS76 11UG
	NULL
};
...
static const char *ALLOWED_FW_G2_3[] __initconst = {
	"14F1EMS1", // Summit E14 Flip Evo A12MT, Summit E14 Evo A12M, Summit E14 Flip Evo A13MT, Prestige 14 Evo B13M
	"14L1EMS1", // Modern 14 H D13M
	"14J1IMS1", // Modern 14 C12M
	"14N1EMS1", // Prestige 14 AI Evo C1MG / Prestige 14 AI Evo C2HMG
	"13P3EMS1", // Summit E13 Flip A12MT
	"13P5EMS1", // Summit 13 AI+ Evo A2VM
	"13Q2EMS1", // Prestige 13 AI Evo A1MG
	"13Q3EMS1", // Prestige 13 AI+ Evo A2VMG
	"14QKIMS1", // Venture A14 AI+ A3HMG
	"15A1EMS1", // Prestige 16 AI Evo B1MG
	"15A3EMS1", // Prestige 16 AI+ Evo B2VMG
	NULL
};
...
static const char *ALLOWED_FW_G2_4[] __initconst = {
	"14N2EMS1", // Prestige 14 AI Studio C1UDXG
	"14P1IMS1", // Cyborg 14 A13VF
	NULL
};
...
static const char *ALLOWED_FW_G2_5[] __initconst = {
	"14K1EMS1", // Stealth 14 Studio A13VF
	"14K2EMS1", // Stealth 14 AI Studio A1VGG / A1VFG
	NULL
};
...
static const char *ALLOWED_FW_G2_6[] __initconst = {
	"16R6EMS1", // GF63 Thin 11UC / 11SC
	"16R7IMS1", // Thin GF63 12HW
	"16R8IMS1", // Thin GF63 12V(E/F) / 12UC / 12UCX
	"16R8IMS2", // Thin 15 B12UCX / B12VE
	"16RKIMS1", // Thin A15 B7VF
	"16RKIMS2",
	NULL
};
...
static const char *ALLOWED_FW_G2_10[] __initconst = {
	"1562EMS1", // Stealth 15M A11SEK
	"1563EMS1", // Stealth 15M A11UEK
	"1571EMS1", // Creator Z16 A11UE
	"1572EMS1", // Creator Z16 A12U
	"1587EMS1", // Katana 15 HX B14WEK
	"158NIMS1", // Katana A15 AI B8V
	"15F2EMS1", // Stealth 16 Studio A13VG
	"15F3EMS1", // Stealth 16 AI Studio A1VHG
	"15F4EMS1", // Stealth 16 AI Studio A1VFG
	"15F5EMS1", // Stealth 16 AI A2HWFG
	"15FKIMS1", // Stealth A16 AI+ A3XVFG / A3XVGG
	"15FLIMS1", // Stealth A16 AI+ A3XWHG
	"15FMIBA1", // Stealth A16 Mercedes AMG AI+ A3XWGG
	"15K2EMS1", // Cyborg 15 AI A1VFK
	"15M1IMS1", // Vector GP68 HX 12V/13V
	"15M1IMS2", // Raider GE68 HX 14VIG / Vector 16 HX A13V* / A14V*
	"15M2IMS2", // Raider GE68 HX 14VGG
	"15M2IMS1", // Raider GE68HX 13V(F/G) / Vector GP68HX 13VF
	"15M3EMS1", // Vector 16 HX AI A2XWHG / A2XWIG
	"15P2EMS1", // Sword 16 HX B13V / B14V
	"15P3EMS1", // Pulse 16 AI C1VGKG/C1VFKG
	"15P4EMS1", // Crosshair 16 HX AI D2XW(GKG)
	"17L5EMS1", // Pulse/Katana 17 B13V/GK
	"17L5EMS2", // Katana 17 B12UCXK / Katana 17 B12VEK
	"17L7EMS1", // Katana 17 HX B14WGK
	"17N1EMS1", // Creator Z17 A12UGST
	"17P1EMS1", // Stealth GS77 12U(E/GS)
	"17P2EMS1", // Stealth 17 Studio A13VI
	"17Q1IMS1", // Titan GT77 12UHS
	"17Q2IMS1", // Titan GT77HX 13VH
	"17S1IMS1", // Raider GE78HX 13VI
	"17S1IMS2", // Raider GE78 HX 14VHG / Vector 17 HX A14V / Vector 17 HX A13VHG
	"17S2IMS1", // Raider GE78 HX Smart Touchpad 13V
	"17S3EMS1", // Vector 17 HX AI A2XWHG
	"17T2EMS1", // Sword 17 HX B14VGKG
	"1822EMS1", // Titan 18 HX A14V
	"1824EMS1", // Titan 18 HX Dragon Edition / Raider 18 HX AI A2XWJG (MS-1824)
	"182LIMS1", // Vector A18 HX A9WHG
	"182KIMS1", // Raider A18 HX A7VIG
	NULL
};
